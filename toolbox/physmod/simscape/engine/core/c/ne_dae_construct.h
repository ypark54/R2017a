...
const char*); void (*mSatisfied) (const CStateManager*, const char*, boolean_T);
boolean_T (*mIsSatisfied) (const CStateManager*, const char*); void
(*mInputDependent) (const CStateManager*, const char*); boolean_T
(*mIsInputDependent) (const CStateManager*, const char*); void (*mAlgebraic)
(const CStateManager*, const char*); boolean_T (*mIsAlgebraic) (const
CStateManager*, const char*); void (*mErrorAll) (const CStateManager*,
...
CStateManager*, StateModelInputsMode); int (*mGetModelModifiedTimeStamp)(const
CStateManager*); void (*mSetModelModifiedTimeStamp)(const CStateManager*, int);
const char* (*mGetModelLastUpdatedDateTime)(const CStateManager*); void
...
void (*mUpdateViewer) (const CStateManager*); void (*mUpdateTarget) (const
...
boolean_T needPairs); PmfMessageId ne_dae_create( NeDae **dae, NeDynamicSystem
*dynamicsystemPtr, NeSolverParameters solverParameters, NeModelParameters
modelParameters, const McLinearAlgebra *linearAlgebraPtr, NeProfiler *profiler,
const NeCompStats *compStats, NeVectorStateManager *vsm, PmAllocator
*allocatorPtr);
#ifdef  __cplusplus
}
#endif /* __cplusplus */
