...
void sf_call_marshall_out_fcn(SimStruct* S, const char* fcnInName, void* var, char*  varName, mxArray* value);
mxArray* sf_call_marshall_in_fcn(SimStruct* S, const char* fcnOutName, void* var, char* varName);
